...
class PaystackTrans extends StatefulWidget {
  static const String id = '/paystackTrans';
  const PaystackTrans({Key? key}) : super(key: key);

  @override
  State<PaystackTrans> createState() => _PaystackTransState();
}

class _PaystackTransState extends State<PaystackTrans> {
